<?xml version='1.0'?>
    ...
    <rx:meta-info>
      ...
      <xsl:if test="exists($title)">
        <rx:meta-field name="title" value="{$title}"/>
         ...
         <rx:meta-field name="title" value="Unterversorgte Dokumentation?"/>
         <rx:meta-field name="subject" value="Der Stand der Technischen Redaktion in Softwareunternehmen"/>
         <rx:meta-field name="keywords" value="DITA, XML, PDF, Techcomm, Technical Writing, Technische Redaktion"/>
   ...
   <!-- external-graphic von front-matter.xsl --> 
        <fo:block text-align="center" width="100%">
          <fo:external-graphic src="url({concat($artworkPrefix, 'Customization/OpenTopic/common/artwork/artikelbild-1.gif')})"/>              
        </fo:block>
