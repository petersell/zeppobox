<?xml version='1.0'?>
    ...
    <rx:meta-info>
      ...
      <xsl:if test="exists($title)">
        <rx:meta-field name="title" value="{$title}"/>
         ...
         <rx:meta-field name="keywords" value="Machtsprache, Macht, SED, FDGB, FDBG-Ausweis, Solidarität, Sprache der Macht"/>
         <rx:meta-field name="subject" value="Der FDBG-Ausweis mit Solidaritätsmarken als Zeichen der Vergottung der Macht."/>
   ...
   <!-- external-graphic von front-matter.xsl --> 
        <fo:block text-align="center" width="100%">
          <fo:external-graphic src="url({concat($artworkPrefix, 'Customization/OpenTopic/common/artwork/artikelbild-6.gif')})"/>              
        </fo:block>
