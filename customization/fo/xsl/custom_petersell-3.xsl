<?xml version='1.0'?>
    ...
    <rx:meta-info>
      ...
      <xsl:if test="exists($title)">
        <rx:meta-field name="title" value="{$title}"/>
         ...
         <rx:meta-field name="title" value="Protagonisten der DDR-Literatur der 70er und 80er Jahre"/>
         <rx:meta-field name="subject" value="Wissenschaftliche Hausarbeit zum Amt des Studienrats zur DDR-Literatur"/>
         <rx:meta-field name="keywords" value="DDR-Literatur, East German Literature, Zensur, Censorship, Monika Maron, Jurek Becker, Christoph Hein, Erich Loesrt"/>
   ...
   <!-- external-graphic von front-matter.xsl --> 
        <fo:block text-align="center" width="100%">
          <fo:external-graphic src="url({concat($artworkPrefix, 'Customization/OpenTopic/common/artwork/artikelbild-3.gif')})"/>              
        </fo:block>
